...
class GetDataJob2 extends Job
{
    ...
    private function getData() {
        $waktu = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/1.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // Sensor O3
        $O3 = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/2.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // Sensor H2S
        $H2S = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/3.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // Sensor DUST
        $DUST = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/4.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // Sensor NH3
        $NH3 = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/5.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // Sensor NO2
        $NO2 = HTTP::GET('https://api.thingspeak.com/channels/1552299/fields/6.json?api_key=BFMQFTRSJFJ1DX8F');
        ...
        // ---------------> Cuaca
        // Sensor TEMPERATURE
        $TEMPERATURE = HTTP::GET('https://api.thingspeak.com/channels/1552297/fields/1.json?api_key=NAH2OD5JMK810AR6');
        ...
        // Sensor HUMIDITY
        $HUMIDITY = HTTP::GET('https://api.thingspeak.com/channels/1552297/fields/2.json?api_key=NAH2OD5JMK810AR6');
        ...
        // Sensor PRESSURE
        $PRESSURE = HTTP::GET('https://api.thingspeak.com/channels/1552297/fields/3.json?api_key=NAH2OD5JMK810AR6');
        ...
        // Sensor RAIN
        $RAIN = HTTP::GET('https://api.thingspeak.com/channels/1552297/fields/4.json?api_key=NAH2OD5JMK810AR6');
        ...
        // ---------------> Angin
        // Sensor WIND SPEED
        $WIND_SPEED = HTTP::GET('https://api.thingspeak.com/channels/1552293/fields/1.json?api_key=HM4FL5Z5NM5J7MFU');
        ...
        // Sensor WIND DIRECT
        $WIND_DIRECT = HTTP::GET('https://api.thingspeak.com/channels/1552293/fields/2.json?api_key=HM4FL5Z5NM5J7MFU');
